...
class About extends React.Component {
  ...
  render() {
	...
	<Typography variant={'h5'} color={'primary'} className={classes.aboutText}>Impressum</Typography>
	  ...
	  <a href='https://www.fu-berlin.de/einrichtungen/organe/praesidium/praesident/'>Der Präsident</a>
	  <h3>Kontakt</h3>
	  <p>Telefon: ++49 (0) 30 838 55193</p>
	  <p>Telefax: (030) 838 -4- 556 21</p>
	  <p>E-Mail: jana.luedtke@fu-berlin.de</p>
